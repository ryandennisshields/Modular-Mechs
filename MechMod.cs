    ...
    public class MechMod : Mod
    {
        ...
        public override void Load()
        {
            ...
            MechParts = new Dictionary<string, MechPart>
            {
                ...
                { "arbalest", new MechPart(ModContent.ItemType<Arbalest>(), "weapon")},
                { "chargecannon", new MechPart(ModContent.ItemType<ChargeCannon>(), "weapon")},
                ...
                { "manashield", new MechPart(ModContent.ItemType<ManaShield>(), "passivemodule")},
                { "relocator", new MechPart(ModContent.ItemType<Relocator>(), "passivemodule")},
                // Active
